...
!       -5*86400.0)
  ...
  if(LIS_rc%forecastMode.eq.0) then !hindcast run
     ...
     write(unit=cyear_p, fmt='(i4.4)') yr-10 ! LB for SE
     ...
     if (yr-10==1979 .and. mo>=2) then
        prefix_p = 'MERRA2_100'
     elseif (yr-10>1979 .and. yr-10<=1991) then
        prefix_p = 'MERRA2_100'
     elseif ( yr-10 >= 1992 .and. yr-10 <= 2000 ) then   ! Since 2000 is last full year
        prefix_p = 'MERRA2_200'
        !  elseif ( yr >= 2001 .and. yr <= 2009 ) then
     elseif ( yr-10 >= 2001 .and. yr-10 <= 2010 ) then   ! Corrected for longitudinal shift of data
        prefix_p = 'MERRA2_300'
        !  elseif ( yr-10 >= 2010 ) then
     elseif ( yr-10 >= 2011 ) then
        prefix_p = 'MERRA2_400'
     else
